"""
Shared model definitions for Paper 3 experiment scripts.
=========================================================

These classes are EXACT copies from flow_matching_3d.py.
...
def sample_latent(unet, method, n, dev, steps, ch=8):
